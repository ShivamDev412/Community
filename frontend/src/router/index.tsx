...
const { LOGIN, SIGNUP, HOME, YOUR_EVENTS, YOUR_GROUPS, CREATE_EVENT, CREATE_GROUP, PROFILE,  EDIT_PROFILE} = RouteEndpoints;
...
const EditProfileScreen = lazy(() => import("../screen/EditProfile"))
const Router = () => {
  return (
    <BrowserRouter>
      <Routes>
